const CONFIG = {
    storeName: "Zann Store",
    ownerName: "Zann Store",
    avatar: "image/logo/logo.jpg",
    instagram: "",
    telegram: "",
    whatsappNumber: "6287830231211",
    adminNumber: "6287830231211"
};
...
const products = [
    { 
       ...
       desc: "•100% AMAN NO BL/BAN\n•BERSIFAT PERMANEN\n•FREE UPDATE KLO ADA YANG ERROR"
    },
    { 
       id: 2, 
       name: "AIMLOCK 90%", 
    ...
    {
       id: 9,
       name: "ANGIN NO HS X AIMLOCK 85%", 
       price: 70000,
       image: "image/produk/produk9.jpg", 
       desc: "XTRA COMBO FILE ANDRO\n\n•100% AMAN NO BL/BAN\n•BERSIFAT PERMANEN\n•FREE UPDATE KLO ADA YANG ERROR"
    },
    {
       id: 10,
       name: "AIM BODY X AIMLOCK 90%", 
       price: 75000,
    ...
    {
       id: 15,
       name: "HEADTRICK EXTREME", 
       price: 70000,
       image: "image/produk/produk15.jpg", 
       desc: "FILE IOS\n\n•100% AMAN NO BL/BAN\n•BERSIFAT PERMANEN\n•FREE UPDATE KLO ADA YANG ERROR"
    },
    {
       id: 16,
       ...
       desc: "SETTINGAN BIAR GAMPANG HS\n\n•100% AMAN NO BL/BAN\n•BERSIFAT PERMANEN\n•FREE UPDATE KLO ADA YANG ERROR"
    },
    {
       id: 17,
       name: "CHEAT VIP FULL FITUR", 
       price: 130000,
       image: "image/produk/produk17.jpg", 
       desc: "•FITUR LEBIH LENGKAP + BRUTAL\n•100% AMAN NO BL/BAN\n•BERSIFAT PERMANEN\n•FREE UPDATE KLO ADA YANG ERROR"
    },
    {
       id: 18,
       name: "PROJECT ALL FILE", 
       price: 250000,
       image: "image/produk/produk18.jpg", 
       desc: "KEUNTUNGAN BELI INI\n\n•BISA JUALAN CHEAT SENDIRI\n•BEBAS SETTING SENDIRI\n•FREE UPDATE KLO ADA YANG ERROR"
    },
...
function showPayment(product) {
    ...
    content.innerHTML = `
        <div style="text-align:center; padding: 0 10px;">
            <img src="image/qris.jpg" class="qris-image" onerror="this.src='https://placehold.co/320x320?text=QRIS'">
...
function renderHome() {
    ...
    main.innerHTML = `
        ...
        <div class="marquee">
            <div class="marquee-text">◈ ⚡ WELCOME TO ZANN STORE • PREMIUM QUALITY • TRUSTED SERVICE • FAST RESPONSE • THANK YOU FOR CHOOSING US ⚡ ◈</div>
        </div>
        ...
        <div class="promo-card"><h4>✨ TERIMA KASIH TELAH BERKUNJUNG</h4><p>Kami menghargai setiap kunjungan dan berharap melayani Anda lagi</p><i class="ri-discount-line promo-deco"></i></div>
    `;
